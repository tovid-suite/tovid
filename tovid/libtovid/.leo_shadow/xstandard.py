#@+leo-ver=4-thin
#@+node:eric.20090722212922.2476:@shadow standard.py
# standard.py
...
#@+others
#@+node:eric.20090722212922.2478:resolution
...
#@-node:eric.20090722212922.2478:resolution
#@+node:eric.20090722212922.2479:vcodec
def vcodec(format):
...
#@-node:eric.20090722212922.2479:vcodec
#@+node:eric.20090722212922.2480:acodec
def acodec(format):
...
#@-node:eric.20090722212922.2480:acodec
#@+node:eric.20090722212922.2481:samprate
def samprate(format):
...
#@-node:eric.20090722212922.2481:samprate
#@+node:eric.20090722212922.2482:fps
def fps(tvsys):
...
#@-node:eric.20090722212922.2482:fps
#@+node:eric.20090722212922.2483:fps_ratio
def fps_ratio(tvsys):
    """Return the number of frames per second for the given TV system,
...
#@-node:eric.20090722212922.2483:fps_ratio
#@+node:eric.20090722212922.2484:vbitrate
def vbitrate(format):
...
#@-node:eric.20090722212922.2484:vbitrate
#@+node:eric.20090722212922.2485:abitrate
def abitrate(format):
