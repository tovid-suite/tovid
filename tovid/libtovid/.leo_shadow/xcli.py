#@+leo-ver=4-thin
#@+node:eric.20090722212922.2408:@shadow cli.py
...
class Command:
    ...
    #@-node:eric.20090722212922.2411:__init__
    #@+node:eric.20090722212922.2412:add
    def add(self, *args):
    ...
    #@-node:eric.20090722212922.2412:add
    #@+node:eric.20090722212922.2413:run
    ...
    #@-node:eric.20090722212922.2413:run
    #@+node:eric.20090722212922.2414:run_redir
    ...
    #@-node:eric.20090722212922.2414:run_redir
    #@+node:eric.20090722212922.2415:wait
    def wait(self):
    ...
    #@-node:eric.20090722212922.2415:wait
    #@+node:eric.20090722212922.2416:kill
    def kill(self):
        """Abort!
        """
    ...
    #@-node:eric.20090722212922.2416:kill
    #@+node:eric.20090722212922.2417:done
    def done(self):
    ...
    #@-node:eric.20090722212922.2417:done
    #@+node:eric.20090722212922.2418:get_output
    def get_output(self):
    ...
    #@-node:eric.20090722212922.2418:get_output
    #@+node:eric.20090722212922.2419:get_error
    def get_error(self):
        """Wait for the command to finish running, and return a string
    ...
    #@-node:eric.20090722212922.2419:get_error
    #@+node:eric.20090722212922.2420:__str__
    def __str__(self):
    ...
    #@-node:eric.20090722212922.2420:__str__
    #@+node:eric.20090722212922.2421:to_script
    def to_script(self):
    ...
    #@-others
#@-node:eric.20090722212922.2410:class Command
#@+node:eric.20090722212922.2422:class Pipe
class Pipe:
    """A series of Commands, each having its output piped into the next.
    """
    #@    @+others
    #@+node:eric.20090722212922.2423:__init__
    ...
    #@-node:eric.20090722212922.2423:__init__
    #@+node:eric.20090722212922.2424:add
    ...
    #@-node:eric.20090722212922.2424:add
    #@+node:eric.20090722212922.2425:run
    def run(self, capture=False, background=False):
    ...
    #@-node:eric.20090722212922.2425:run
    #@+node:eric.20090722212922.2426:get_output
    def get_output(self):
    ...
    #@-node:eric.20090722212922.2426:get_output
    #@+node:eric.20090722212922.2427:__str__
    def __str__(self):
    ...
    #@-others
#@-node:eric.20090722212922.2422:class Pipe
#@+node:eric.20090722212922.2428:_enc_arg
def _enc_arg(arg):
