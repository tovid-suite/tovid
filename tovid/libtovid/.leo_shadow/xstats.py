#@+leo-ver=4-thin
#@+node:eric.20090722212922.2486:@shadow stats.py
# stats.py
...
#@+others
#@+node:eric.20090722212922.2487:stats declarations
...
#@-node:eric.20090722212922.2487:stats declarations
#@+node:eric.20090722212922.2488:class Statlist
class Statlist:
    """A list of statistics that may be queried with a simple database-like
    interface."""
    #@    @+others
    #@+node:eric.20090722212922.2489:__init__
    ...
    #@-node:eric.20090722212922.2489:__init__
    #@+node:eric.20090722212922.2490:read_csv
    ...
    #@-node:eric.20090722212922.2490:read_csv
    #@+node:eric.20090722212922.2491:unique
    ...
    #@-node:eric.20090722212922.2491:unique
    #@+node:eric.20090722212922.2492:count_unique
    ...
    #@-node:eric.20090722212922.2492:count_unique
    #@+node:eric.20090722212922.2493:average
    ...
    #@-node:eric.20090722212922.2493:average
    #@+node:eric.20090722212922.2494:average_by
    ...
    #@-node:eric.20090722212922.2494:average_by
    #@+node:eric.20090722212922.2495:list_by
    ...
    #@-node:eric.20090722212922.2495:list_by
    #@+node:eric.20090722212922.2496:get_matching
    ...
    #@-node:eric.20090722212922.2496:get_matching
    #@+node:eric.20090722212922.2497:length
    ...
    #@-node:eric.20090722212922.2497:length
    #@+node:eric.20090722212922.2498:show
