#@+leo-ver=4-thin
#@+node:eric.20090722212922.3440:@shadow textmenu.py
__all__ = ['TextMenu']
...
class TextMenu:
    ...
    #@-node:eric.20090722212922.3443:__init__
    #@+node:eric.20090722212922.3444:generate
    def generate(self):
        """Generate the menu.
        """
    ...
    #@-node:eric.20090722212922.3444:generate
    #@+node:eric.20090722212922.3445:build_reusables
    ...
    #@-node:eric.20090722212922.3445:build_reusables
    #@+node:eric.20090722212922.3446:draw_background_canvas
    ...
    #@-node:eric.20090722212922.3446:draw_background_canvas
    #@+node:eric.20090722212922.3447:draw_background_layer
    ...
    #@-node:eric.20090722212922.3447:draw_background_layer
    #@+node:eric.20090722212922.3448:draw_highlight_layer
    ...
    #@-node:eric.20090722212922.3448:draw_highlight_layer
    #@+node:eric.20090722212922.3449:draw_selection_layer
    ...
    #@-node:eric.20090722212922.3449:draw_selection_layer
    #@+node:eric.20090722212922.3450:gen_video
    def gen_video(self):
    ...
    #@-node:eric.20090722212922.3450:gen_video
    #@+node:eric.20090722212922.3451:gen_audio
    def gen_audio(self):
    ...
    #@-node:eric.20090722212922.3451:gen_audio
    #@+node:eric.20090722212922.3452:gen_mpeg
    def gen_mpeg(self):
    ...
    #@-node:eric.20090722212922.3452:gen_mpeg
    #@+node:eric.20090722212922.3453:mux_subtitles
