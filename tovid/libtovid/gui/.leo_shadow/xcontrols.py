#@+leo-ver=4-thin
#@+node:eric.20090722212922.2816:@shadow controls.py
# controls.py
...
#@+others
#@+node:eric.20090722212922.2818:class BoldToggleButton
class BoldToggleButton(wx.ToggleButton):
    """A wx.ToggleButton with bold font"""
    #@    @+others
    #@+node:eric.20090722212922.2819:__init__
...
class FlexTreeCtrl(wx.TreeCtrl):
    ...
    #@-node:eric.20090722212922.2821:__init__
    #@+node:eric.20090722212922.2822:CopyChildren
    ...
    #@-node:eric.20090722212922.2822:CopyChildren
    #@+node:eric.20090722212922.2823:MoveChildren
    ...
    #@-node:eric.20090722212922.2823:MoveChildren
    #@+node:eric.20090722212922.2824:AppendItemCopy
    ...
    #@-node:eric.20090722212922.2824:AppendItemCopy
    #@+node:eric.20090722212922.2825:PrependItemCopy
    ...
    #@-node:eric.20090722212922.2825:PrependItemCopy
    #@+node:eric.20090722212922.2826:InsertItemCopy
    ...
    #@-node:eric.20090722212922.2826:InsertItemCopy
    #@+node:eric.20090722212922.2827:AppendItemMove
    ...
    #@-node:eric.20090722212922.2827:AppendItemMove
    #@+node:eric.20090722212922.2828:PrependItemMove
    ...
    #@-node:eric.20090722212922.2828:PrependItemMove
    #@+node:eric.20090722212922.2829:InsertItemMove
    ...
    #@-node:eric.20090722212922.2829:InsertItemMove
    #@+node:eric.20090722212922.2830:ItemIsAncestorOf
    ...
    #@-node:eric.20090722212922.2830:ItemIsAncestorOf
    #@+node:eric.20090722212922.2831:MoveItemUp
    def MoveItemUp(self):
    ...
    #@-node:eric.20090722212922.2831:MoveItemUp
    #@+node:eric.20090722212922.2832:MoveItemDown
    ...
    #@-node:eric.20090722212922.2832:MoveItemDown
    #@+node:eric.20090722212922.2833:Delete
    ...
    #@-node:eric.20090722212922.2833:Delete
    #@+node:eric.20090722212922.2834:GetReferenceList
    ...
    #@-node:eric.20090722212922.2834:GetReferenceList
    #@+node:eric.20090722212922.2835:GetItemList
    ...
    #@-others
#@-node:eric.20090722212922.2820:class FlexTreeCtrl
#@+node:eric.20090722212922.2836:class HeadingText
class HeadingText(wx.StaticText):
    """A large, bold static text control to use for headings"""
    #@    @+others
    #@+node:eric.20090722212922.2837:__init__
    def __init__(self, parent, id, label):
