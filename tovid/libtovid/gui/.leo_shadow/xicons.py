#@+leo-ver=4-thin
#@+node:eric.20090722212922.2872:@shadow icons.py
# icons.py
...
#@+others
#@+node:eric.20090722212922.2874:MenuIcon
def MenuIcon():
...
#@-node:eric.20090722212922.2874:MenuIcon
#@+node:eric.20090722212922.2875:SlideIcon
def SlideIcon():
...
#@-node:eric.20090722212922.2875:SlideIcon
#@+node:eric.20090722212922.2876:VideoIcon
def VideoIcon():
...
#@-node:eric.20090722212922.2876:VideoIcon
#@+node:eric.20090722212922.2877:DiscIcon
def DiscIcon():
...
#@-node:eric.20090722212922.2877:DiscIcon
#@+node:eric.20090722212922.2878:GroupIcon
def GroupIcon():
...
#@-node:eric.20090722212922.2878:GroupIcon
#@+node:eric.20090722212922.2879:AppIcon
def AppIcon():
