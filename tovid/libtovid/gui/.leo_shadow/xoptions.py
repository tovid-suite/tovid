#@+leo-ver=4-thin
#@+node:eric.20090722212922.2880:@shadow options.py
# options.py
...
#@+others
#@+node:eric.20090722212922.2882:class DiscOptions
class DiscOptions:
    ...
    #@    @+others
    #@+node:eric.20090722212922.2883:__init__
    def __init__(self, format = 'dvd', tvsys = 'ntsc'):
        self.format = format
        self.tvsys = tvsys

    #@-node:eric.20090722212922.2883:__init__
    #@+node:eric.20090722212922.2884:SetLayout
    ...
    #@-node:eric.20090722212922.2884:SetLayout
    #@+node:eric.20090722212922.2885:GetCommand
    def GetCommand(self):
    ...
    #@-node:eric.20090722212922.2885:GetCommand
    #@+node:eric.20090722212922.2886:DiscNameOK
    ...
    #@-node:eric.20090722212922.2886:DiscNameOK
    #@+node:eric.20090722212922.2887:OutputDirectoryExists
    ...
    #@-node:eric.20090722212922.2887:OutputDirectoryExists
    #@+node:eric.20090722212922.2888:RelevantFilesAreOK
    ...
    #@-others
#@-node:eric.20090722212922.2882:class DiscOptions
#@+node:eric.20090722212922.2889:class GroupOptions
class GroupOptions:
...
#    addoptions = ""
    ...
    #@    @+others
    #@+node:eric.20090722212922.2890:__init__
    ...
    #@-node:eric.20090722212922.2890:__init__
    #@+node:eric.20090722212922.2891:toElement
    def toElement(self):
    ...
    #@-node:eric.20090722212922.2891:toElement
    #@+node:eric.20090722212922.2892:fromElement
    ...
    #@-node:eric.20090722212922.2892:fromElement
    #@+node:eric.20090722212922.2893:GetCommand
    def GetCommand(self):
    ...
    #@-node:eric.20090722212922.2896:CopyFrom
    #@+node:eric.20090722212922.2897:GroupOutputOK
    ...
    #@-node:eric.20090722212922.2897:GroupOutputOK
    #@+node:eric.20090722212922.2898:RelevantFilesAreOK
    def RelevantFilesAreOK(self, panel):
    ...
    #@-others
#@-node:eric.20090722212922.2889:class GroupOptions
#@+node:eric.20090722212922.2899:class MenuOptions
class MenuOptions:
    ...
    #@    @+others
    #@+node:eric.20090722212922.2900:__init__
    def __init__(self, format = 'dvd', tvsys = 'ntsc',
    ...
    #@-node:eric.20090722212922.2900:__init__
    #@+node:eric.20090722212922.2901:GetCommand
    def GetCommand(self):
    ...
    #@-node:eric.20090722212922.2901:GetCommand
    #@+node:eric.20090722212922.2902:SetDiscFormat
    def SetDiscFormat(self, format):
        """Make menu compliant with given disc format."""
        self.format = format 

    #@-node:eric.20090722212922.2902:SetDiscFormat
    #@+node:eric.20090722212922.2903:SetDiscTVSystem
    def SetDiscTVSystem(self, tvsys):
        """Make menu compliant with given disc TV system."""
        self.tvsys = tvsys

    #@-node:eric.20090722212922.2903:SetDiscTVSystem
    #@+node:eric.20090722212922.2904:CopyFrom
    def CopyFrom(self, opts):
    ...
    #@-node:eric.20090722212922.2904:CopyFrom
    #@+node:eric.20090722212922.2905:AudioFileOK
    ...
    #@-node:eric.20090722212922.2905:AudioFileOK
    #@+node:eric.20090722212922.2906:ImageFileOK
    ...
    #@-node:eric.20090722212922.2906:ImageFileOK
    #@+node:eric.20090722212922.2907:HeaderOK
    ...
    #@-node:eric.20090722212922.2907:HeaderOK
    #@+node:eric.20090722212922.2908:OutputFileOK
    ...
    #@-node:eric.20090722212922.2908:OutputFileOK
    #@+node:eric.20090722212922.2909:RelevantFilesAreOK
    def RelevantFilesAreOK(self, panel):
    ...
    #@-others
#@-node:eric.20090722212922.2899:class MenuOptions
#@+node:eric.20090722212922.2910:class VideoOptions
class VideoOptions:
    ...
    #@    @+others
    #@+node:eric.20090722212922.2911:__init__
    def __init__(self, format = 'dvd', tvsys = 'ntsc',
        filename = ""):
        self.SetDiscTVSystem(tvsys)
        self.SetDiscFormat(format)
    ...
    #@-node:eric.20090722212922.2911:__init__
    #@+node:eric.20090722212922.2912:GetCommand
    def GetCommand(self):
        ...
        strCommand += "-from-gui -noask"
        return strCommand

    #@-node:eric.20090722212922.2912:GetCommand
    #@+node:eric.20090722212922.2913:SetDiscFormat
    def SetDiscFormat(self, format):
    ...
    #@-node:eric.20090722212922.2913:SetDiscFormat
    #@+node:eric.20090722212922.2914:SetDiscTVSystem
    def SetDiscTVSystem(self, tvsys):
        """Make menu compliant with given disc TV system."""
        self.tvsys = tvsys

    #@-node:eric.20090722212922.2914:SetDiscTVSystem
    #@+node:eric.20090722212922.2915:CopyFrom
    def CopyFrom(self, opts):
        """Copy the given options into this object."""
        # If types are different, return
        if self.type != opts.type:
    ...
    #@-node:eric.20090722212922.2915:CopyFrom
    #@+node:eric.20090722212922.2916:VideoFileOK
    ...
    #@-node:eric.20090722212922.2916:VideoFileOK
    #@+node:eric.20090722212922.2917:VideoOutputOK
    ...
    #@-node:eric.20090722212922.2917:VideoOutputOK
    #@+node:eric.20090722212922.2918:RelevantFilesAreOK
    def RelevantFilesAreOK(self, panel):
        """Check the video options for any errors detectable before encoding"""
