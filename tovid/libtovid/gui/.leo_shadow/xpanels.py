#@+leo-ver=4-thin
#@+node:eric.20090722212922.2919:@shadow panels.py
# panels.py
...
#@+others
#@+node:eric.20090722212922.2921:class AuthorFilesTaskPanel
class AuthorFilesTaskPanel(wx.Panel):
    ...
    #@    @+others
    #@+node:eric.20090722212922.2922:__init__
    ...
    #@-node:eric.20090722212922.2922:__init__
    #@+node:eric.20090722212922.2923:EncodeOK
    ...
    #@-node:eric.20090722212922.2923:EncodeOK
    #@+node:eric.20090722212922.2924:BurnOK
    def BurnOK(self, ok):
    ...
    #@-node:eric.20090722212922.2924:BurnOK
    #@+node:eric.20090722212922.2925:OnLayout
    ...
    #@-node:eric.20090722212922.2925:OnLayout
    #@+node:eric.20090722212922.2926:OnEncode
    ...
    #@-node:eric.20090722212922.2926:OnEncode
    #@+node:eric.20090722212922.2927:OnBurn
    def OnBurn(self, evt):
    ...
    #@-others
#@-node:eric.20090722212922.2921:class AuthorFilesTaskPanel
#@+node:eric.20090722212922.2928:class BurnDiscPanel
class BurnDiscPanel(wx.Panel):
    """A panel of controls for burning a disc"""
    #@    @+others
    #@+node:eric.20090722212922.2929:__init__
    ...
    #@-node:eric.20090722212922.2929:__init__
    #@+node:eric.20090722212922.2930:OnDoAuthor
    def OnDoAuthor(self, evt):
        self.doAuthor = evt.Checked()
        self.SetCommands()

    #@-node:eric.20090722212922.2930:OnDoAuthor
    #@+node:eric.20090722212922.2931:OnDoBurn
    def OnDoBurn(self, evt):
        self.doBurn = evt.Checked()
        self.SetCommands()

    #@-node:eric.20090722212922.2931:OnDoBurn
    #@+node:eric.20090722212922.2932:OnSetDevice
    ...
    #@-node:eric.20090722212922.2932:OnSetDevice
    #@+node:eric.20090722212922.2933:OnStart
    ...
    #@-node:eric.20090722212922.2933:OnStart
    #@+node:eric.20090722212922.2934:ProcessingDone
    ...
    #@-node:eric.20090722212922.2934:ProcessingDone
    #@+node:eric.20090722212922.2935:SetCommands
    ...
    #@-node:eric.20090722212922.2935:SetCommands
    #@+node:eric.20090722212922.2936:SetCommandsWithoutClearingList
    ...
    #@-others
#@-node:eric.20090722212922.2928:class BurnDiscPanel
#@+node:eric.20090722212922.2937:class CommandOutputPanel
class CommandOutputPanel(wx.Panel):
    ...
    #@    @+others
    #@+node:eric.20090722212922.2938:__init__
    def __init__(self, parent, id):
        wx.Panel.__init__(self, parent, id)
    ...
    #@-node:eric.20090722212922.2938:__init__
    #@+node:eric.20090722212922.2939:__del__
    def __del__(self):
    ...
    #@-node:eric.20090722212922.2939:__del__
    #@+node:eric.20090722212922.2940:OnFontSize
    ...
    #@-node:eric.20090722212922.2940:OnFontSize
    #@+node:eric.20090722212922.2941:OnSaveLog
    ...
    #@-node:eric.20090722212922.2941:OnSaveLog
    #@+node:eric.20090722212922.2942:OnSaveAsScript
    ...
    #@-node:eric.20090722212922.2942:OnSaveAsScript
    #@+node:eric.20090722212922.2943:OnIdleTime
    ...
    #@-node:eric.20090722212922.2943:OnIdleTime
    #@+node:eric.20090722212922.2944:StartNextProcess
    ...
    #@-node:eric.20090722212922.2944:StartNextProcess
    #@+node:eric.20090722212922.2945:OnProcessEnded
    ...
    #@-node:eric.20090722212922.2945:OnProcessEnded
    #@+node:eric.20090722212922.2946:Clear
    def Clear(self):
    ...
    #@-node:eric.20090722212922.2946:Clear
    #@+node:eric.20090722212922.2947:Execute
    ...
    #@-node:eric.20090722212922.2947:Execute
    #@+node:eric.20090722212922.2948:Start
    def Start(self):
    ...
    #@-node:eric.20090722212922.2948:Start
    #@+node:eric.20090722212922.2949:Stop
    def Stop(self):
...
class DiscLayoutPanel(wx.Panel):
    ...
    #@-node:eric.20090722212922.2951:__init__
    #@+node:eric.20090722212922.2952:OnTreeSelChanged
    ...
    #@-node:eric.20090722212922.2952:OnTreeSelChanged
    #@+node:eric.20090722212922.2953:OnTreeItemEdit
    ...
    #@-node:eric.20090722212922.2953:OnTreeItemEdit
    #@+node:eric.20090722212922.2954:OnAddMenu
    ...
    #@-node:eric.20090722212922.2954:OnAddMenu
    #@+node:eric.20090722212922.2955:OnAddVideos
    ...
    #@-node:eric.20090722212922.2955:OnAddVideos
    #@+node:eric.20090722212922.2956:OnAddGroup
    ...
    #@-node:eric.20090722212922.2956:OnAddGroup
    #@+node:eric.20090722212922.2957:OnCuritemUp
    ...
    #@-node:eric.20090722212922.2957:OnCuritemUp
    #@+node:eric.20090722212922.2958:OnCuritemDown
    ...
    #@-node:eric.20090722212922.2958:OnCuritemDown
    #@+node:eric.20090722212922.2959:OnRemoveCuritem
    ...
    #@-node:eric.20090722212922.2962:SetDiscFormat
    #@+node:eric.20090722212922.2963:SetDiscTVSystem
    ...
    #@-node:eric.20090722212922.2963:SetDiscTVSystem
    #@+node:eric.20090722212922.2964:RefreshItem
    ...
    #@-node:eric.20090722212922.2964:RefreshItem
    #@+node:eric.20090722212922.2965:UseForAllItems
    ...
    #@-node:eric.20090722212922.2965:UseForAllItems
    #@+node:eric.20090722212922.2966:CheckForNoDuplicateOutputFiles
    ...
    #@-node:eric.20090722212922.2966:CheckForNoDuplicateOutputFiles
    #@+node:eric.20090722212922.2967:CheckMenuCountLimitsNotExceeded
    ...
    #@-node:eric.20090722212922.2967:CheckMenuCountLimitsNotExceeded
    #@+node:eric.20090722212922.2968:CheckForNoGroupsWhenNotDVD
    ...
    #@-node:eric.20090722212922.2968:CheckForNoGroupsWhenNotDVD
    #@+node:eric.20090722212922.2969:PerformSanityCheckOnFiles
    ...
    #@-node:eric.20090722212922.2969:PerformSanityCheckOnFiles
    #@+node:eric.20090722212922.2970:GetAllCommands
    ...
    #@-node:eric.20090722212922.2970:GetAllCommands
    #@+node:eric.20090722212922.2971:GetIcon
    ...
    #@-others
#@-node:eric.20090722212922.2950:class DiscLayoutPanel
#@+node:eric.20090722212922.2972:class DiscPanel
class DiscPanel(wx.Panel):
    """Panel for choosing disc format (DVD/VCD/SVCD, PAL/NTSC)"""
    #@    @+others
    #@+node:eric.20090722212922.2973:__init__
    ...
    #@-node:eric.20090722212922.2973:__init__
    #@+node:eric.20090722212922.2974:OnFormat
    ...
    #@-node:eric.20090722212922.2974:OnFormat
    #@+node:eric.20090722212922.2975:OnTVSystem
    ...
    #@-node:eric.20090722212922.2975:OnTVSystem
    #@+node:eric.20090722212922.2976:OnBrowseOutputDirectory
    ...
    #@-node:eric.20090722212922.2976:OnBrowseOutputDirectory
    #@+node:eric.20090722212922.2977:OnEditOutputDirectory
    ...
    #@-node:eric.20090722212922.2977:OnEditOutputDirectory
    #@+node:eric.20090722212922.2978:SetOptions
    ...
    #@-others
#@-node:eric.20090722212922.2972:class DiscPanel
#@+node:eric.20090722212922.2979:class EncodingPanel
class EncodingPanel(wx.Panel):
    ...
    """
    #@    @+others
    #@+node:eric.20090722212922.2980:__init__
    def __init__(self, parent, id):
        wx.Panel.__init__(self, parent, id)
        self.parent = parent
        self.curConfig = TovidConfig()
    ...
    #@-node:eric.20090722212922.2980:__init__
    #@+node:eric.20090722212922.2981:OnBrowseOutDir
    ...
    #@-node:eric.20090722212922.2981:OnBrowseOutDir
    #@+node:eric.20090722212922.2982:OnStartStop
    ...
    #@-node:eric.20090722212922.2982:OnStartStop
    #@+node:eric.20090722212922.2983:SetCommands
...
class GroupPanel(wx.Panel):
    ...
    #@-node:eric.20090722212922.2987:__init__
    #@+node:eric.20090722212922.2988:SetOptions
    ...
    #@-node:eric.20090722212922.2988:SetOptions
    #@+node:eric.20090722212922.2989:GetOptions
    def GetOptions(self):
    ...
    #@-others
#@-node:eric.20090722212922.2986:class GroupPanel
#@+node:eric.20090722212922.2990:class GuidePanel
class GuidePanel(wx.Panel):
    """A panel showing live context-sensitive help."""
    #@    @+others
    #@+node:eric.20090722212922.2991:__init__
    ...
    #@-node:eric.20090722212922.2991:__init__
    #@+node:eric.20090722212922.2992:InitTaskText
    ...
    #@-node:eric.20090722212922.2992:InitTaskText
    #@+node:eric.20090722212922.2993:SetTask
    ...
    #@-others
#@-node:eric.20090722212922.2990:class GuidePanel
#@+node:eric.20090722212922.2994:class HidablePanel
class HidablePanel(wx.Panel):
    ...
    """
    #@    @+others
    #@+node:eric.20090722212922.2995:__init__
    ...
    #@-node:eric.20090722212922.2995:__init__
    #@+node:eric.20090722212922.2996:SetContent
    ...
    #@-others
#@-node:eric.20090722212922.2994:class HidablePanel
#@+node:eric.20090722212922.2999:class MenuPanel
class MenuPanel(wx.Panel):
    """A panel showing controls appropriate to generating a menu"""
    #@    @+others
    #@+node:eric.20090722212922.3000:__init__
    def __init__(self, parent, id):
        wx.Panel.__init__(self, parent, id)
    ...
    #@-node:eric.20090722212922.3000:__init__
    #@+node:eric.20090722212922.3001:OnMenuTitle
    ...
    #@-node:eric.20090722212922.3001:OnMenuTitle
    #@+node:eric.20090722212922.3002:OnMenuTitleFontSize
    ...
    #@-node:eric.20090722212922.3002:OnMenuTitleFontSize
    #@+node:eric.20090722212922.3003:OnBGImage
    ...
    #@-node:eric.20090722212922.3003:OnBGImage
    #@+node:eric.20090722212922.3004:OnBGAudio
    ...
    #@-node:eric.20090722212922.3004:OnBGAudio
    #@+node:eric.20090722212922.3005:OnMenuLength
    ...
    #@-node:eric.20090722212922.3005:OnMenuLength
    #@+node:eric.20090722212922.3006:OnBrowseBGImage
    ...
    #@-node:eric.20090722212922.3006:OnBrowseBGImage
    #@+node:eric.20090722212922.3007:OnBrowseBGAudio
    ...
    #@-node:eric.20090722212922.3007:OnBrowseBGAudio
    #@+node:eric.20090722212922.3008:OnAlignment
    ...
    #@-node:eric.20090722212922.3008:OnAlignment
    #@+node:eric.20090722212922.3009:OnFillType
    ...
    #@-node:eric.20090722212922.3009:OnFillType
    #@+node:eric.20090722212922.3010:OnColorNone
    ...
    #@-node:eric.20090722212922.3010:OnColorNone
    #@+node:eric.20090722212922.3011:OnPattern
    ...
    #@-node:eric.20090722212922.3011:OnPattern
    #@+node:eric.20090722212922.3012:OnFontSelection
    ...
    #@-node:eric.20090722212922.3012:OnFontSelection
    #@+node:eric.20090722212922.3013:OnFontSize
    def OnFontSize(self, evt):
    ...
    #@-node:eric.20090722212922.3013:OnFontSize
    #@+node:eric.20090722212922.3014:OnFillColor
    ...
    #@-node:eric.20090722212922.3014:OnFillColor
    #@+node:eric.20090722212922.3015:OnFillColor2
    ...
    #@-node:eric.20090722212922.3015:OnFillColor2
    #@+node:eric.20090722212922.3016:OnStrokeColor
    ...
    #@-node:eric.20090722212922.3016:OnStrokeColor
    #@+node:eric.20090722212922.3017:OnStrokeWidth
    ...
    #@-node:eric.20090722212922.3017:OnStrokeWidth
    #@+node:eric.20090722212922.3018:OnButtonFontSelection
    ...
    #@-node:eric.20090722212922.3018:OnButtonFontSelection
    #@+node:eric.20090722212922.3019:OnLockButtonFont
    ...
    #@-node:eric.20090722212922.3019:OnLockButtonFont
    #@+node:eric.20090722212922.3020:UpdateButtonExample
    ...
    #@-node:eric.20090722212922.3020:UpdateButtonExample
    #@+node:eric.20090722212922.3021:UpdateButtonFontChooserButton
    ...
    #@-node:eric.20090722212922.3021:UpdateButtonFontChooserButton
    #@+node:eric.20090722212922.3022:OnHiColor
    ...
    #@-node:eric.20090722212922.3022:OnHiColor
    #@+node:eric.20090722212922.3023:OnSelColor
    ...
    #@-node:eric.20090722212922.3023:OnSelColor
    #@+node:eric.20090722212922.3024:OnButton
    ...
    #@-node:eric.20090722212922.3024:OnButton
    #@+node:eric.20090722212922.3025:OnButtonOutlineColor
    ...
    #@-node:eric.20090722212922.3025:OnButtonOutlineColor
    #@+node:eric.20090722212922.3026:OnUseForAll
    ...
    #@-node:eric.20090722212922.3026:OnUseForAll
    #@+node:eric.20090722212922.3027:SetOptions
    ...
    #@-node:eric.20090722212922.3027:SetOptions
    #@+node:eric.20090722212922.3028:GetOptions
    def GetOptions(self):
        """Get currently-set encoding options."""
        return self.curOptions

    #@-node:eric.20090722212922.3028:GetOptions
    #@+node:eric.20090722212922.3029:SetDiscFormat
    def SetDiscFormat(self, format):
    ...
    #@-others
#@-node:eric.20090722212922.2999:class MenuPanel
#@+node:eric.20090722212922.3030:class VideoPanel
class VideoPanel(wx.Panel):
    """A panel showing controls appropriate to encoding a video."""
    #@    @+others
    #@+node:eric.20090722212922.3031:__init__
    def __init__(self, parent, id):
        wx.Panel.__init__(self, parent, id)
    ...
    #@-node:eric.20090722212922.3031:__init__
    #@+node:eric.20090722212922.3032:OnFormat
    def OnFormat(self, evt):
    ...
    #@-node:eric.20090722212922.3032:OnFormat
    #@+node:eric.20090722212922.3033:OnAspect
    ...
    #@-node:eric.20090722212922.3033:OnAspect
    #@+node:eric.20090722212922.3034:OnQualityChange
    ...
    #@-node:eric.20090722212922.3034:OnQualityChange
    #@+node:eric.20090722212922.3035:OnEncodingChange
    ...
    #@-node:eric.20090722212922.3035:OnEncodingChange
    #@+node:eric.20090722212922.3036:OnCLIOptions
    ...
    #@-node:eric.20090722212922.3036:OnCLIOptions
    #@+node:eric.20090722212922.3037:OnUseForAll
    def OnUseForAll(self, evt):
    ...
    #@-node:eric.20090722212922.3037:OnUseForAll
    #@+node:eric.20090722212922.3038:OnPreview
    ...
    #@-node:eric.20090722212922.3038:OnPreview
    #@+node:eric.20090722212922.3039:SetOptions
    ...
    #@-node:eric.20090722212922.3039:SetOptions
    #@+node:eric.20090722212922.3040:GetOptions
    def GetOptions(self):
        """Return the currently-set encoding options."""
        return self.curOptions

    #@-node:eric.20090722212922.3040:GetOptions
    #@+node:eric.20090722212922.3041:SetDiscFormat
    def SetDiscFormat(self, format):
    ...
    #@-node:eric.20090722212922.3041:SetDiscFormat
    #@+node:eric.20090722212922.3042:SetDiscTVSystem
    ...
    #@-others
#@-node:eric.20090722212922.3030:class VideoPanel
#@+node:eric.20090722212922.3043:class PlaylistTabPanel
# ************************************************************************
#
# todiscgui panels
#
...
class PlaylistTabPanel(wx.Panel):
    #@    @+others
    #@+node:eric.20090722212922.3044:__init__
    def __init__(self, parent, id):
        wx.Panel.__init__(self, parent, id)
    ...
    #@-node:eric.20090722212922.3044:__init__
    #@+node:eric.20090722212922.3045:EnableSubmenus
    ...
    #@-node:eric.20090722212922.3045:EnableSubmenus
    #@+node:eric.20090722212922.3046:DisableSubmenus
    ...
    #@-node:eric.20090722212922.3046:DisableSubmenus
    #@+node:eric.20090722212922.3047:submenus_OnClick
    ...
    #@-node:eric.20090722212922.3047:submenus_OnClick
    #@+node:eric.20090722212922.3048:btnAddVideo_OnClick
    ...
    #@-node:eric.20090722212922.3048:btnAddVideo_OnClick
    #@+node:eric.20090722212922.3049:btnRemoveVideo_OnClick
    ...
    #@-node:eric.20090722212922.3049:btnRemoveVideo_OnClick
    #@+node:eric.20090722212922.3050:btnAudio_OnClick
    ...
    #@-node:eric.20090722212922.3050:btnAudio_OnClick
    #@+node:eric.20090722212922.3051:btnOut_OnClick
    ...
    #@-others
#@-node:eric.20090722212922.3043:class PlaylistTabPanel
#@+node:eric.20090722212922.3052:class MenuTabPanel
class MenuTabPanel(wx.Panel):
    #@    @+others
    #@+node:eric.20090722212922.3053:__init__
    def __init__(self, parent, id):
        wx.Panel.__init__(self, parent, id)
        # todisc options controlled by this panel, and default values
        # (as a dictionary of option/value pairs)
    ...
    #@-node:eric.20090722212922.3053:__init__
    #@+node:eric.20090722212922.3054:EnableSubmenus
    def EnableSubmenus(self):
    ...
    #@-node:eric.20090722212922.3054:EnableSubmenus
    #@+node:eric.20090722212922.3055:DisableSubmenus
    def DisableSubmenus(self):
    ...
    #@-node:eric.20090722212922.3055:DisableSubmenus
    #@+node:eric.20090722212922.3056:btnMenuFont_OnClick
    ...
    #@-node:eric.20090722212922.3056:btnMenuFont_OnClick
    #@+node:eric.20090722212922.3057:btnTitleColor_OnClick
    ...
    #@-node:eric.20090722212922.3057:btnTitleColor_OnClick
    #@+node:eric.20090722212922.3058:btnStrokeColor_OnClick
    ...
    #@-node:eric.20090722212922.3058:btnStrokeColor_OnClick
    #@+node:eric.20090722212922.3059:text_mist_OnClick
    ...
    #@-node:eric.20090722212922.3059:text_mist_OnClick
    #@+node:eric.20090722212922.3060:static_OnClick
    ...
    #@-others
#@-node:eric.20090722212922.3052:class MenuTabPanel
#@+node:eric.20090722212922.3064:class ThumbnailTabPanel
class ThumbnailTabPanel(wx.Panel):
    #@    @+others
    #@+node:eric.20090722212922.3065:__init__
    def __init__(self, parent, id):
        self.todisc_opts = {\
            'thumb-shape': None,
            'thumb-font': None,
    ...
    #@-node:eric.20090722212922.3065:__init__
    #@+node:eric.20090722212922.3066:feather_thumbs_OnClick
    ...
    #@-others
#@-node:eric.20090722212922.3064:class ThumbnailTabPanel
#@+node:eric.20090722212922.3067:class DebugTabPanel
class DebugTabPanel(wx.Panel):
    #@    @+others
    #@+node:eric.20090722212922.3068:__init__
    def __init__(self, parent, id):
        wx.Panel.__init__(self, parent, id)
