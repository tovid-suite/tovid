#@+leo-ver=4-thin
#@+node:eric.20090722212922.2807:@shadow configs.py
# configs.py
...
#@+others
#@+node:eric.20090722212922.2809:class TovidConfig
class TovidConfig:
    ...
    #@    @+others
    #@+node:eric.20090722212922.2810:__init__
    def __init__(self):
    ...
    #@-node:eric.20090722212922.2810:__init__
    #@+node:eric.20090722212922.2811:ConfigAvailFonts
    ...
    #@-node:eric.20090722212922.2811:ConfigAvailFonts
    #@+node:eric.20090722212922.2812:UseLanguage
    def UseLanguage(self, lang):
        self.trans[ lang ].install()

    #@-node:eric.20090722212922.2812:UseLanguage
    #@+node:eric.20090722212922.2813:InitLocales
