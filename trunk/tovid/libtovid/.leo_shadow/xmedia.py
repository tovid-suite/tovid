#@+leo-ver=4-thin
#@+node:eric.20090722212922.2440:@shadow media.py
...
#@+others
#@+node:eric.20090722212922.2442:class MediaFile
class MediaFile:
    """A multimedia video file, and its vital statistics.
    """
    #@    @+others
    #@+node:eric.20090722212922.2443:__init__
    ...
    #@-node:eric.20090722212922.2443:__init__
    #@+node:eric.20090722212922.2444:__str__
    def __str__(self):
    ...
    #@-others
#@-node:eric.20090722212922.2442:class MediaFile
#@+node:eric.20090722212922.2445:standard_media
...
#@-node:eric.20090722212922.2445:standard_media
#@+node:eric.20090722212922.2446:correct_aspect
