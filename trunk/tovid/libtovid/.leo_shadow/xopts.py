#@+leo-ver=4-thin
#@+node:eric.20090722212922.2463:@shadow opts.py
# opts.py
...
#@+others
#@+node:eric.20090722212922.2465:class Option
class Option (object):
    ...
    """
    #@    @+others
    #@+node:eric.20090722212922.2466:__init__
    ...
    #@-node:eric.20090722212922.2466:__init__
    #@+node:eric.20090722212922.2467:num_args
    def num_args(self):
    ...
    #@-node:eric.20090722212922.2467:num_args
    #@+node:eric.20090722212922.2468:__str__
    def __str__(self):
    ...
    #@-others
#@-node:eric.20090722212922.2465:class Option
#@+node:eric.20090722212922.2469:class Usage
class Usage (object):
    """Command-line usage definition."""
    #@    @+others
    #@+node:eric.20090722212922.2470:__init__
    ...
    #@-node:eric.20090722212922.2470:__init__
    #@+node:eric.20090722212922.2471:__str__
    def __str__(self):
    ...
    #@-others
#@-node:eric.20090722212922.2469:class Usage
#@+node:eric.20090722212922.2472:parse
...
#@-node:eric.20090722212922.2472:parse
#@+node:eric.20090722212922.2473:validate
import re
