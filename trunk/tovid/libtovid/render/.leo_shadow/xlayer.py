#@+leo-ver=4-thin
#@+node:eric.20090722212922.3228:@shadow layer.py
...
#@+others
#@+node:eric.20090722212922.3230:class Layer
class Layer:
    ...
    """
    #@    @+others
    #@+node:eric.20090722212922.3231:__init__
    def __init__(self):
    ...
    #@-node:eric.20090722212922.3231:__init__
    #@+node:eric.20090722212922.3232:init_childs
    ###
    ...
    #@-node:eric.20090722212922.3232:init_childs
    #@+node:eric.20090722212922.3233:init_parent_flipbook
    def init_parent_flipbook(self, flipbook):
        self._parent_flipbook = flipbook

    #@-node:eric.20090722212922.3233:init_parent_flipbook
    #@+node:eric.20090722212922.3234:init_parent_layer
    def init_parent_layer(self, layer):
        self._parent_layer = layer


    #@-node:eric.20090722212922.3234:init_parent_layer
    #@+node:eric.20090722212922.3235:draw
    ###
    ...
    #@-node:eric.20090722212922.3235:draw
    #@+node:eric.20090722212922.3236:add_sublayer
    ###
    ...
    #@-node:eric.20090722212922.3236:add_sublayer
    #@+node:eric.20090722212922.3237:draw_sublayers
    ...
    #@-node:eric.20090722212922.3237:draw_sublayers
    #@+node:eric.20090722212922.3238:add_effect
    ...
    #@-node:eric.20090722212922.3238:add_effect
    #@+node:eric.20090722212922.3239:draw_with_effects
    ...
    #@-others
#@-node:eric.20090722212922.3230:class Layer
#@+node:eric.20090722212922.3240:class MyLayer
#@+at
# Layer template
# 
...
class MyLayer (Layer):
    ...
    #@    @+others
    #@+node:eric.20090722212922.3241:__init__
    ...
    #@-node:eric.20090722212922.3241:__init__
    #@+node:eric.20090722212922.3242:draw
...
#@-node:eric.20090722212922.3240:class MyLayer
#@+node:eric.20090722212922.3243:class Background
class Background (Layer):
    """A background that fills the frame with a solid color, or an image."""
    #@    @+others
    #@+node:eric.20090722212922.3244:__init__
    ...
    #@-node:eric.20090722212922.3244:__init__
    #@+node:eric.20090722212922.3245:draw
    def draw(self, drawing, frame):
        assert isinstance(drawing, Drawing)
    ...
    #@-others
#@-node:eric.20090722212922.3243:class Background
#@+node:eric.20090722212922.3246:class Image
class Image (Layer):
    ...
    """
    #@    @+others
    #@+node:eric.20090722212922.3247:__init__
    ...
    #@-node:eric.20090722212922.3247:__init__
    #@+node:eric.20090722212922.3248:draw
    ...
    #@-others
#@-node:eric.20090722212922.3246:class Image
#@+node:eric.20090722212922.3249:class VideoClip
class VideoClip (Layer):
    ...
    """
    #@    @+others
    #@+node:eric.20090722212922.3250:__init__
    ...
    #@-node:eric.20090722212922.3250:__init__
    #@+node:eric.20090722212922.3251:rip_frames
    ...
    #@-node:eric.20090722212922.3251:rip_frames
    #@+node:eric.20090722212922.3252:draw
    def draw(self, drawing, frame=1):
    ...
    #@-others
#@-node:eric.20090722212922.3249:class VideoClip
#@+node:eric.20090722212922.3253:class Text
class Text (Layer):
    """A simple text string, with size, color and font.
    """
    #@    @+others
    #@+node:eric.20090722212922.3254:__init__
    ...
    #@-node:eric.20090722212922.3254:__init__
    #@+node:eric.20090722212922.3255:extents
    ...
    #@-node:eric.20090722212922.3255:extents
    #@+node:eric.20090722212922.3256:draw
    def draw(self, drawing, frame=1):
        assert isinstance(drawing, Drawing)
    ...
    #@-others
#@-node:eric.20090722212922.3253:class Text
#@+node:eric.20090722212922.3257:class ShadedText
class ShadedText (Layer):
    """A simple text string, with size, color and font.
    """
    #@    @+others
    #@+node:eric.20090722212922.3258:__init__
    ...
    #@-node:eric.20090722212922.3258:__init__
    #@+node:eric.20090722212922.3259:draw
    def draw(self, drawing, frame=1):
        assert isinstance(drawing, Drawing)
        log.debug("Drawing Text")
        drawing.save()
    ...
    #@-others
#@-node:eric.20090722212922.3257:class ShadedText
#@+node:eric.20090722212922.3260:class Label
class Label (Text):
    ...
    """
    #@    @+others
    #@+node:eric.20090722212922.3261:__init__
    ...
    #@-node:eric.20090722212922.3261:__init__
    #@+node:eric.20090722212922.3262:draw
    def draw(self, drawing, frame=1):
        assert isinstance(drawing, Drawing)
    ...
    #@-others
#@-node:eric.20090722212922.3260:class Label
#@+node:eric.20090722212922.3263:class Thumb
class Thumb (Layer):
    """A thumbnail image or video.
    """
    #@    @+others
    #@+node:eric.20090722212922.3264:__init__
    ...
    #@-node:eric.20090722212922.3264:__init__
    #@+node:eric.20090722212922.3265:draw
    def draw(self, drawing, frame=1):
        assert isinstance(drawing, Drawing)
    ...
    #@-others
#@-node:eric.20090722212922.3263:class Thumb
#@+node:eric.20090722212922.3266:class ThumbGrid
class ThumbGrid (Layer):
    """A rectangular array of thumbnail images or videos."""
    #@    @+others
    #@+node:eric.20090722212922.3267:__init__
    ...
    #@-node:eric.20090722212922.3267:__init__
    #@+node:eric.20090722212922.3268:_fit_items
    ...
    #@-node:eric.20090722212922.3268:_fit_items
    #@+node:eric.20090722212922.3269:draw
    def draw(self, drawing, frame=1):
        assert isinstance(drawing, Drawing)
    ...
    #@-others
#@-node:eric.20090722212922.3266:class ThumbGrid
#@+node:eric.20090722212922.3270:class SafeArea
class SafeArea (Layer):
    """Render a safe area box at a given percentage.
    """
    #@    @+others
    #@+node:eric.20090722212922.3271:__init__
    def __init__(self, percent, color):
        self.percent = percent
        self.color = color

    #@-node:eric.20090722212922.3271:__init__
    #@+node:eric.20090722212922.3272:draw
    def draw(self, drawing, frame=1):
        assert isinstance(drawing, Drawing)
    ...
    #@-others
#@-node:eric.20090722212922.3270:class SafeArea
#@+node:eric.20090722212922.3273:class Scatterplot
class Scatterplot (Layer):
    """A 2D scatterplot of data.
    """
    #@    @+others
    #@+node:eric.20090722212922.3274:__init__
    ...
    #@-node:eric.20090722212922.3274:__init__
    #@+node:eric.20090722212922.3275:draw
    def draw(self, drawing, frame):
    ...
    #@-others
#@-node:eric.20090722212922.3273:class Scatterplot
#@+node:eric.20090722212922.3276:class InterpolationGraph
class InterpolationGraph (Layer):
    ...
    """
    #@    @+others
    #@+node:eric.20090722212922.3277:__init__
    ...
    #@-node:eric.20090722212922.3277:__init__
    #@+node:eric.20090722212922.3278:draw
    def draw(self, drawing, frame):
...
class ColorBars (Layer):
    ...
    #@-node:eric.20090722212922.3280:__init__
    #@+node:eric.20090722212922.3281:draw
    def draw(self, drawing, frame=1):
        assert isinstance(drawing, Drawing)
...
#@<<main>>
#@+node:eric.20090723212423.3644:<<main>>
