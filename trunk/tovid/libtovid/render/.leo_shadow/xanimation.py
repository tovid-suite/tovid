#@+leo-ver=4-thin
#@+node:eric.20090722212922.3083:@shadow animation.py
...
#@+others
#@+node:eric.20090722212922.3085:class Keyframe
class Keyframe:
    ...
    """
    #@    @+others
    #@+node:eric.20090722212922.3086:__init__
    ...
    #@-others
#@-node:eric.20090722212922.3085:class Keyframe
#@+node:eric.20090723212423.3635:Interpolation algorithms
### --------------------------------------------------------------------------
### Interpolation algorithms
### --------------------------------------------------------------------------

#@+node:eric.20090722212922.3087:lerp
...
#@-node:eric.20090722212922.3087:lerp
#@+node:eric.20090722212922.3088:cos_interp
...
#@-node:eric.20090722212922.3088:cos_interp
#@-node:eric.20090723212423.3635:Interpolation algorithms
#@+node:eric.20090722212922.3089:interpolate
...
#@-node:eric.20090722212922.3089:interpolate
#@+node:eric.20090722212922.3090:class Tween
class Tween:
    ...
    """
    #@    @+others
    #@+node:eric.20090722212922.3091:__init__
    ...
    #@-node:eric.20090722212922.3091:__init__
    #@+node:eric.20090722212922.3092:_tween
    def _tween(self):
    ...
    #@-node:eric.20090722212922.3092:_tween
    #@+node:eric.20090722212922.3093:__getitem__
