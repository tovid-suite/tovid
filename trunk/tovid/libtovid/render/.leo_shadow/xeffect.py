#@+leo-ver=4-thin
#@+node:eric.20090722212922.3167:@shadow effect.py
...
class Effect:
    ...
    #@-node:eric.20090722212922.3170:__init__
    #@+node:eric.20090722212922.3171:init_parent_flipbook
    def init_parent_flipbook(self, fb):
        self._parent_flipbook = fb


    #@-node:eric.20090722212922.3171:init_parent_flipbook
    #@+node:eric.20090722212922.3172:init_parent_layer
    def init_parent_layer(self, layer):
        self._parent_layer = layer


    #@-node:eric.20090722212922.3172:init_parent_layer
    #@+node:eric.20090722212922.3173:pre_draw
    ...
    #@-node:eric.20090722212922.3173:pre_draw
    #@+node:eric.20090722212922.3174:post_draw
    ...
    #@-others
#@-node:eric.20090722212922.3169:class Effect
#@+node:eric.20090722212922.3175:class MyEffect
#@+at
# New Effect template
# 
...
class MyEffect (Effect):
    ...
    """
    #@    @+others
    #@+node:eric.20090722212922.3176:__init__
    #@+at
    ...
    #@-node:eric.20090722212922.3176:__init__
    #@+node:eric.20090722212922.3177:draw
    ...
    #@-node:eric.20090722212922.3177:draw
    #@+node:eric.20090722212922.3178:pre_draw
    ...
    #@-node:eric.20090722212922.3178:pre_draw
    #@+node:eric.20090722212922.3179:post_draw
...
#@-node:eric.20090722212922.3175:class MyEffect
#@+node:eric.20090722212922.3180:class Movement
class Movement (Effect):
    """A movement effect, from one point to another."""
    #@    @+others
    #@+node:eric.20090722212922.3181:__init__
    ...
    #@-node:eric.20090722212922.3181:__init__
    #@+node:eric.20090722212922.3182:pre_draw
    def pre_draw(self, drawing, frame):
        drawing.save()
        drawing.translate(*self.tween[frame])

    #@-node:eric.20090722212922.3182:pre_draw
    #@+node:eric.20090722212922.3183:post_draw
    def post_draw(self, drawing, frame):
        drawing.restore()
    ...
    #@-others
#@-node:eric.20090722212922.3180:class Movement
#@+node:eric.20090722212922.3184:class Translate
class Translate (Movement):
    """Translates the layer to some relative (x,y) coordinates
    """
    #@    @+others
    #@+node:eric.20090722212922.3185:__init__
    ...
    #@-others
#@-node:eric.20090722212922.3184:class Translate
#@+node:eric.20090722212922.3186:class Fade
class Fade (Effect):
    """A generic fade effect, varying the opacity of a layer.
    """
    #@    @+others
    #@+node:eric.20090722212922.3187:__init__
    ...
    #@-node:eric.20090722212922.3187:__init__
    #@+node:eric.20090722212922.3188:pre_draw
    def pre_draw(self, drawing, frame):
    ...
    #@-node:eric.20090722212922.3188:pre_draw
    #@+node:eric.20090722212922.3189:post_draw
    def post_draw(self, drawing, frame):
    ...
    #@-others
#@-node:eric.20090722212922.3186:class Fade
#@+node:eric.20090722212922.3190:class FadeInOut
class FadeInOut (Fade):
    #@    @+others
    #@+node:eric.20090722212922.3191:__init__
...
class Colorfade (Effect):
    ...
    #@-node:eric.20090722212922.3193:__init__
    #@+node:eric.20090722212922.3194:pre_draw
    def pre_draw(self, drawing, frame):
        """Set source color"""
    ...
    #@-node:eric.20090722212922.3194:pre_draw
    #@+node:eric.20090722212922.3195:post_draw
    def post_draw(self, drawing, frame):
        pass
...
class Spectrum (Effect):
    ...
    #@-node:eric.20090722212922.3197:__init__
    #@+node:eric.20090722212922.3198:pre_draw
    def pre_draw(self, drawing, frame):
        drawing.set_source(self.tween[frame])


    #@-node:eric.20090722212922.3198:pre_draw
    #@+node:eric.20090722212922.3199:post_draw
    def post_draw(self, drawing, frame):
        pass
    ...
    #@-others
#@-node:eric.20090722212922.3196:class Spectrum
#@+node:eric.20090722212922.3200:class Scale
class Scale (Effect):
    """A Scaling effect, from one size to another.
    """
    #@    @+others
    #@+node:eric.20090722212922.3201:__init__
    ...
    #@-node:eric.20090722212922.3201:__init__
    #@+node:eric.20090722212922.3202:pre_draw
    def pre_draw(self, drawing, frame):
        drawing.save()
    ...
    #@-node:eric.20090722212922.3202:pre_draw
    #@+node:eric.20090722212922.3203:post_draw
    def post_draw(self, drawing, frame):
        drawing.restore()
    ...
    #@-others
#@-node:eric.20090722212922.3200:class Scale
#@+node:eric.20090722212922.3204:class Whirl
class Whirl (Effect):
    """Rotates an object a number of times.
    """
    #@    @+others
    #@+node:eric.20090722212922.3205:__init__
    ...
    #@-node:eric.20090722212922.3205:__init__
    #@+node:eric.20090722212922.3206:pre_draw
    def pre_draw(self, drawing, frame):
        drawing.save()
    ...
    #@-node:eric.20090722212922.3206:pre_draw
    #@+node:eric.20090722212922.3207:post_draw
    def post_draw(self, drawing, frame):
    ...
    #@-others
#@-node:eric.20090722212922.3204:class Whirl
#@+node:eric.20090722212922.3208:class PhotoZoom
class PhotoZoom (Effect):
    ...
    """
    #@    @+others
    #@+node:eric.20090722212922.3209:__init__
    ...
    #@-node:eric.20090722212922.3209:__init__
    #@+node:eric.20090722212922.3210:pre_draw
    def pre_draw(self, drawing, frame):
        drawing.save()
    ...
    #@-node:eric.20090722212922.3210:pre_draw
    #@+node:eric.20090722212922.3211:post_draw
    def post_draw(self, drawing, frame):
        drawing.restore()
    ...
    #@-others
#@-node:eric.20090722212922.3208:class PhotoZoom
#@+node:eric.20090722212922.3212:class KeyFunction
class KeyFunction (Effect):
    """A keyframed effect on an arbitrary Drawing function.
    """
    #@    @+others
    #@+node:eric.20090722212922.3213:__init__
    ...
    #@-node:eric.20090722212922.3213:__init__
    #@+node:eric.20090722212922.3214:pre_draw
    def pre_draw(self, drawing, frame):
        drawing.save()
        self.draw_function(drawing, self.tween[frame])

    #@-node:eric.20090722212922.3214:pre_draw
    #@+node:eric.20090722212922.3215:post_draw
    def post_draw(self, drawing, frame):
        drawing.restore()
