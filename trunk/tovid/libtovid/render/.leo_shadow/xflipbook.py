#@+leo-ver=4-thin
#@+node:eric.20090722212922.3216:@shadow flipbook.py
...
#@+others
#@+node:eric.20090722212922.3218:class Flipbook
class Flipbook:
    """A collection of Drawings that together comprise an animation.
    """
    #@    @+others
    #@+node:eric.20090722212922.3219:__init__
    ...
    #@-node:eric.20090722212922.3219:__init__
    #@+node:eric.20090722212922.3220:init_childs
    ...
    #@-node:eric.20090722212922.3220:init_childs
    #@+node:eric.20090722212922.3221:stof
    ...
    #@-node:eric.20090722212922.3221:stof
    #@+node:eric.20090722212922.3222:get_canvas_size
    ...
    #@-node:eric.20090722212922.3222:get_canvas_size
    #@+node:eric.20090722212922.3223:add
    ...
    #@-node:eric.20090722212922.3223:add
    #@+node:eric.20090722212922.3224:render
    ...
    #@-node:eric.20090722212922.3224:render
    #@+node:eric.20090722212922.3225:get_drawing
    ...
    #@-node:eric.20090722212922.3225:get_drawing
    #@+node:eric.20090722212922.3226:render_video
    ...
    #@-others
#@-node:eric.20090722212922.3218:class Flipbook
#@+node:eric.20090722212922.3227:draw_text_demo
#@-node:eric.20090722212922.3227:draw_text_demo
#@-others

#@<<main>>
#@+node:eric.20090723160216.3612:<<main>>
