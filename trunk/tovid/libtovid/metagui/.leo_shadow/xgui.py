#@+leo-ver=4-thin
#@+node:eric.20090722212922.2627:@shadow gui.py
...
class Executor (Widget):
    ...
    #@-node:eric.20090722212922.2630:__init__
    #@+node:eric.20090722212922.2631:draw
    ...
    #@-node:eric.20090722212922.2631:draw
    #@+node:eric.20090722212922.2632:send_stdin
    ...
    #@-node:eric.20090722212922.2632:send_stdin
    #@+node:eric.20090722212922.2633:execute
    ...
    #@-node:eric.20090722212922.2633:execute
    #@+node:eric.20090722212922.2634:kill
    def kill(self):
    ...
    #@-node:eric.20090722212922.2634:kill
    #@+node:eric.20090722212922.2635:poll
    def poll(self):
    ...
    #@-node:eric.20090722212922.2636:notify
    #@+node:eric.20090722212922.3498:write
    def write(self, line):
    ...
    #@-node:eric.20090722212922.3498:write
    #@+node:eric.20090722212922.3499:clear
    def clear(self):
    ...
    #@-node:eric.20090722212922.3499:clear
    #@+node:eric.20090722212922.3500:save_log
    def save_log(self):
    ...
    #@-others
#@-node:eric.20090722212922.2629:class Executor
#@+node:eric.20090722212922.2637:class Application
class Application (Widget):
    """Graphical frontend for a command-line program
    """
    #@    @+others
    #@+node:eric.20090722212922.2638:__init__
    ...
    #@-node:eric.20090722212922.2638:__init__
    #@+node:eric.20090722212922.2639:draw
    def draw(self, master):
    ...
    #@-node:eric.20090722212922.2639:draw
    #@+node:eric.20090722212922.2640:draw_toolbar
    ...
    #@-node:eric.20090722212922.2640:draw_toolbar
    #@+node:eric.20090722212922.2641:get_args
    def get_args(self):
    ...
    #@-node:eric.20090722212922.2641:get_args
    #@+node:eric.20090722212922.2642:execute
    def execute(self):
    ...
    #@-node:eric.20090722212922.2643:save_script
    #@+node:eric.20090722212922.2644:load_script
    ...
    #@-others
#@-node:eric.20090722212922.2637:class Application
#@+node:eric.20090722212922.2645:class GUI
class GUI (tk.Tk):
    """GUI with one or more Applications
    """
    #@    @+others
    #@+node:eric.20090722212922.2646:__init__
    ...
    #@-node:eric.20090722212922.2646:__init__
    #@+node:eric.20090722212922.2647:run
    def run(self):
        """Run the GUI.
        """
        self.draw()
    ...
    #@-node:eric.20090722212922.2647:run
    #@+node:eric.20090722212922.2648:draw
    def draw(self):
        """Draw widgets.
        """
    ...
    #@-node:eric.20090722212922.2648:draw
    #@+node:eric.20090722212922.2649:redraw
    def redraw(self):
    ...
    #@-node:eric.20090722212922.2649:redraw
    #@+node:eric.20090722212922.2650:show_config
